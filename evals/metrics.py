"""
RAGAS + Tool Correctness metrics.
...
CONTEXT_TRUNCATE = 700  # chars per context chunk — reduces single request from ~7,700 to ~400 tokens
CONTEXT_LIMIT = 4       # number of context chunks passed to RAGAS per sample
